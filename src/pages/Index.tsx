...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-foreground">
      ...
      {/* Footer */}
      <footer className="bg-black border-t border-border/30 pt-12 pb-40 md:pt-16 md:pb-44 px-4 md:px-6">
        <div className="container max-w-[1400px] mx-auto text-center space-y-5 md:space-y-6">
          ...
          <div className="flex items-center justify-center gap-4 text-[10px] md:text-xs text-muted-foreground/60 font-light">
            <Link to="/politica-de-privacidad" className="hover:text-muted-foreground transition-colors">
              Política de Privacidad
            </Link>
            <span>·</span>
            <Link to="/terminos-y-condiciones" className="hover:text-muted-foreground transition-colors">
